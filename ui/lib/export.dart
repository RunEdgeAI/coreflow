  ...
  void _addReferenceElement(xml.XmlBuilder builder, Reference ref) {
    ...
    if (ref is ObjectArray) {
                  ...
                  nest: () {
                    ...
                    if (objectAttrs['shape'] != null) {
                      builder.element(
                        ...
                        nest: () {
                          builder.text(
                            (objectAttrs['shape'] as List).join(', '),
                          );
                        },
                      );
                    }
      ...
      builder.element(
        ...
        nest: () {
          builder.element(
            ref.elemType.toLowerCase(),
            nest: ref.value.toString(),
          );
        },
      );
      ...
      builder.element(
        'threshold',
        attributes: {'reference': ref.id.toString()},
        nest: () {
      ...
      builder.element(
        'reference',
        attributes: {'reference': ref.id.toString(), 'type': ref.type},
      );
    }
  }
        ...
        builder.element(
          ...
          nest: () {
            ...
            for (var node in graph.nodes) {
              builder.element(
                'node',
                attributes: {'reference': node.id.toString()},
                nest: () {
...
class DotExport {
  const DotExport({required this.graphs, required this.graphIndex});
