/*!
 * \file  vx_ext_opencv.h
 * \brief The OpenVX OpenCV Nodes Extension Library.
 *
 * \defgroup group_opencv Extension: OpenCV Interop API
 * \ingroup group_extensions
 * \brief OpenVX OpenCV Interop Nodes for OpenCV Functionality within OpenVX Graph.
 *
 * @copyright Copyright (c) 2025 Edge AI, LLC. All rights reserved.
 *
 */
#ifndef VX_EXT_OPENCV_H
#define VX_EXT_OPENCV_H
