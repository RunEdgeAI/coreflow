            ...
            if (borders.mode == VX_BORDER_UNDEFINED)
            {
                ...
                for (y = 1; y < (src_addr.dim_y - 1); y++)
                {
                    for (x = 1; x < (src_addr.dim_x - 1); x++)
                    {
                        vx_uint8* gdx[] =
                        {
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x + 1, y - 1, &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x + 1, y,     &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x + 1, y + 1, &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x - 1, y - 1, &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x - 1, y,     &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x - 1, y + 1, &src_addr)
                        ...
                        {
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x - 1, y + 1, &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x,     y + 1, &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x + 1, y + 1, &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x - 1, y - 1, &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x,     y - 1, &src_addr),
                            (vx_uint8*)vxFormatImagePatchAddress2d(src_base, x + 1, y - 1, &src_addr)
                        ...
                        vx_int16* out_x = (vx_int16*)vxFormatImagePatchAddress2d(dst_base_x, x, y, &dst_addr_x);
                        vx_int16* out_y = (vx_int16*)vxFormatImagePatchAddress2d(dst_base_y, x, y, &dst_addr_y);
