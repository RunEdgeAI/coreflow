...
vx_status ownNorm(vx_image input_x, vx_image input_y, vx_scalar norm_type, vx_image output)
{
    ...
    for (y = 0; y < src_addr_x.dim_y; y++)
    {
        ...
        {
            vx_float32* in_x = (vx_float32*)vxFormatImagePatchAddress2d(src_base_x, x, y, &src_addr_x);
            vx_float32* in_y = (vx_float32*)vxFormatImagePatchAddress2d(src_base_y, x, y, &src_addr_y);
            vx_float32* dst = (vx_float32*)vxFormatImagePatchAddress2d(dst_base, x, y, &dst_addr);
            vx_float32 value;
