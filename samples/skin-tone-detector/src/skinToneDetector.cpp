...
int main(int argc, char **argv)
{
    ...
    vxSetThresholdAttribute(thresh95, VX_THRESHOLD_THRESHOLD_VALUE, &thresValue95,
                            sizeof(vx_int32));
    ...
    vxSetThresholdAttribute(thresh40, VX_THRESHOLD_THRESHOLD_VALUE, &thresValue40,
                            sizeof(vx_int32));
    ...
    vxSetThresholdAttribute(thresh20, VX_THRESHOLD_THRESHOLD_VALUE, &thresValue20,
                            sizeof(vx_int32));
    ...
    vxSetThresholdAttribute(thresh15, VX_THRESHOLD_THRESHOLD_VALUE, &thresValue15,
                            sizeof(vx_int32));
